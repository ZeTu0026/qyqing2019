...
//            spuBo.setValid(spu.getValid());
            ...
            List<String> names = categoryService.queryNamesById(Arrays.asList(spuBo.getCid1(), spuBo.getCid2(), spuBo.getCid3()));

            spuBo.setCname(StringUtils.join(names,"/")); //手机/手机通讯/手机

           Brand brand = brandService.queryBrandById(spuBo.getBrandId());
    ...
    public void updateGoods(SpuBo spuBo) {
        ...
        //update tb_spu_detail set descripition = spuBo.getSpuDetail().getdescription where spu_id=2
